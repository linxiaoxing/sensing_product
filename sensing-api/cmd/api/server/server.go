...
import (
	...
	"github.com/yokusp/sensing-api/internal/http/middlewares"
	"github.com/yokusp/sensing-api/internal/http/routes"
...
func NewApp() (*App, error) {
	...
	routes.NewDetectionRoute(api, conn, jwtService, redisCache, ristrettoCache, authMiddleware, mailerService).Routes()
